...
**Status:** built, branch-reviewed on both axes, and proved against the running
application. Logged here on 2026-09-18; the merge into main is the pull request
on `feature/12c-suche-nach-art`.
